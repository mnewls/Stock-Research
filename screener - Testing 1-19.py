...
def bar_chart_stock_scrape():
    ...
    for i in range(50):
        i+=1
        #/html/body/main/div/div[2]/div[2]/div/div[2]/div/div/div/div[7]/div/div[2]/div/div/ng-transclude/table/tbody/tr[1]/td[1]/div/span[2]/a
...
'''def unusual_volume():
    ...
    select_source = Select(driver.find_element_by_xpath("/html/body/div/div/div[1]/div[1]/div/label/select"))
    select_source.select_by_visible_text("100")
    ...
    for i in range(64):
        ...
        #/html/body/div/div/div[2]/div/table/tbody/tr[1]/th/a
        #/html/body/div/div/div[2]/div/table/tbody/tr[2]/th/a

        path = "/html/body/div/div/div[2]/div/table/tbody/tr[" + str(i) + "]/th/a"
